...
export default function ConferencesScreen() {
  ...
  const handleViewConferenceDetails = (conference: Conference) => {
    ...
    // Use the currentConference ID if viewing the active conference
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <ThemedText style={styles.headerTitle}>Your Conferences</ThemedText>
            <TouchableOpacity
              style={[styles.addButton, { backgroundColor: tintColor }]}
              onPress={handleCreateNewConference}
            >
              <Ionicons name="add" size={24} color="white" />
              <ThemedText style={styles.addButtonText}>New Conference</ThemedText>
            </TouchableOpacity>
          </View>
        }
