...
export default function ConferenceDetailScreen() {
  ...
  useEffect(() => {
    console.log("Conference detail screen - params id:", id);
    console.log("Available conferences:", conferences);
    console.log("Current active conference:", currentConference);
    
    // If id is undefined but we have a currentConference, redirect to the tabs screen instead
    if (!id && currentConference) {
      console.log("No ID provided, redirecting to tabs screen");
    ...
    if (id) {
      ...
      if (foundConference) {
        ...
        const foundTalks = talks.filter(talk => talk.conferenceId === id)
  ...
  if (!conference) {
    // If ID is undefined and we have a currentConference, use that
    if (!id && currentConference) {
      return (
        <View style={styles.centered}>
          <ThemedText>Redirecting to current conference...</ThemedText>
        </View>
      );
    }
      ...
      <ScrollView>
          ...
          <View style={styles.headerContent}>
            ...
            {conference.location && (
              <ThemedText style={styles.location}>
                <Ionicons name="location-outline" size={16} /> {conference.location}
              </ThemedText>
            )}
        ...
        <ThemedView style={styles.section}>
          <View style={styles.sectionHeader}>
            <ThemedText style={styles.sectionTitle}>Talks Timeline</ThemedText>
