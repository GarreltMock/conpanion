  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <ThemedView style={styles.container}>
        <ThemedText style={styles.title}>Create New Conference</ThemedText>
        ...
        <ThemedView style={styles.formSection}>
          ...
          <TextInput
            style={[styles.textArea, { color: textColor, backgroundColor: backgroundColor }]}
            value={description}
          ...
          <View style={styles.buttonRow}>
            ...
            <TouchableOpacity
              style={[styles.button, styles.createButton, { backgroundColor: tintColor, opacity: isSubmitting ? 0.7 : 1 }]}
